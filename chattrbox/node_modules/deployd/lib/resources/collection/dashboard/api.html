...
<script type="text/html" id="api-template">
  ...
  <div class="tab-content tab-content-styled">
    ...
    <p>Deployd generates a <a href="http://docs.deployd.com/docs/collections/reference/dpd-js.html">browser JavaScript API</a> for easily accessing data from the <code><%= '/' + resourceData.id %></code> collection. To use it you first need to include the generated script.</p>
